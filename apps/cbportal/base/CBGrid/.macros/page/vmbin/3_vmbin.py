def main(j, args, params, tags, tasklet):
    ...
    def remove_icon(row, field):
        ...
        return page.getActionHtml('action-DestroyMachine', tags, 'glyphicon glyphicon-remove')

    def restore_icon(row, field):
        tags = {"data-machineId": row[field]}
        return page.getActionHtml('action-RestoreMachine', tags, 'glyphicon glyphicon-repeat')
