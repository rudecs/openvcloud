def main(j, args, params, tags, tasklet):
    ...
    vmcl = j.core.osis.getClientForCategory(j.core.portal.active.osis, 'cloudbroker', 'vmachine')
    stackcl = j.core.osis.getClientForCategory(j.core.portal.active.osis, 'cloudbroker', 'stack')
    imgcl = j.core.osis.getClientForCategory(j.core.portal.active.osis, 'cloudbroker', 'image')
