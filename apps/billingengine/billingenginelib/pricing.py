...
class pricing(object):
    def __init__(self):
        ...
        for machine_price_key in hrd.prefix('instance.openvcloud.billing.machineprices'):
        ...
        self.primary_storage_price = hrd.getFloat('instance.openvcloud.billing.primarystorageprice')
        self.extra_cloudspace_price = hrd.getFloat('instance.openvcloud.billing.extracloudspaceprice')
