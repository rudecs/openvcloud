...
class cloudapi_paypal(BaseActor):
    ...
    def __init__(self):
        ...
        self.paypal_user = self.hrd.get('mothership1.cloudbroker.paypal.apiuser')
        self.paypal_secret = self.hrd.get('mothership1.cloudbroker.paypal.apisecret')

        self.paypal_url = 'https://api.sandbox.paypal.com'
        usesandbox = self.hrd.get('mothership1.cloudbroker.paypal.sandbox')
