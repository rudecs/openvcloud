...
def install_prereqs():
    ...
    ##dialog nginx curl mc python-gevent python-simplejson python-numpy byobu python-apt ipython python-pip python-imaging python-requests python-paramiko gcc g++ python-dev python-zmq msgpack-python python-mhash python-libvirt wget openssl ca-certificates php5-cgi
