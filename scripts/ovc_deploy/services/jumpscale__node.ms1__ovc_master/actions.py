...
class Actions(ActionsBase):
    ...
    def configure(self, serviceObj):
        ...
        def createmachine():
            ...
            machineid, ip, port = j.tools.ms1.createMachine(spacesecret, "ovc_master", memsize="4", \
                ssdsize=40, vsansize=0, description='',imagename="ubuntu.14.04.x64",delete=False, sshkey=sshkey)
    ...
    def removedata(self, serviceObj):
        ...
        ms1client_hrd = j.application.getAppInstanceHRD("ms1_client","main")
        spacesecret = ms1client_hrd.get("instance.param.secret")
        j.tools.ms1.deleteMachine(spacesecret, "ovc_master")
